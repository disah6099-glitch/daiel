            ...
            {step === 2 && (
              <div data-testid="step-details">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <Field label="Monthly salary (₦)" name="monthlySalary" type="number" min="0" value={details.monthlySalary} onChange={(e) => setDetails({ ...details, monthlySalary: e.target.value })} placeholder="0" error={errors.monthlySalary} data-testid="input-monthly-salary" />
